...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        Then, you need to define four lists:
            ...
            -- self.model_names (str list):         define networkss used in our training.
            -- self.visual_names (str list):        specify the images that you want to display and save.
            -- self.optimizers (optimizer list):    define and initialize optimizers. You can define one optimizer for each network. If two networkss are updated at the same time, you can use itertools.chain to group them. See cycle_gan_model.py for an example.
        """
        self.opt = opt
    ...
    def setup(self, opt):
        """Load and print networkss; create schedulers
        Parameters:
            opt (Option class) -- stores all the experiment flags; needs to be a subclass of BaseOptions
        """
        # frozen model
    ...
    def update_learning_rate(self):
        """Update learning rates for all the networkss; called at the end of every epoch"""
    ...
    def save_networks(self, epoch, iter_count=-1):
        """Save all the networkss to the disk.
        Parameters:
    ...
    def load_networks(self, epoch):
        """Load all the networkss from the disk.
        Parameters:
            epoch (int) -- current epoch; used in the file name '%s_net_%s.pth' % (epoch, name)
        """
        for name in self.model_names:
    ...
    def set_requires_grad(self, nets, requires_grad=False):
        """Set requies_grad=Fasle for all the networkss to avoid unnecessary computations
        Parameters:
            nets (network list)   -- a list of networkss
            requires_grad (bool)  -- whether the networkss require gradients or not
        """
